...
const Breadcrumb = ({ currentPageName, links }) => {
    ...
    return (
        <>
            <section className='w-full flex items-center justify-between gap-3 mb-5 border-y py-2'>
                    ...
                    <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        {links && links.map((item, index) => (
                            <li key={index} className="inline-flex items-center">
                                <HiChevronRight />
                                <Link to={item.path} className="ms-2 inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                                    {item.name}
                                </Link>
                            </li>
                        ))}
                        ...
                        <li aria-current="page">
                            <div className="flex items-center">
                                <HiChevronRight />
                                <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">{currentPageName}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
