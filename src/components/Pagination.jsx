...
const Pagination = ({
    ...
    meta: { total, to, from, current_page, last_page, path } = {
        total: 0,
        to: 0,
        from: 0,
        current_page: 0,
            ...
            <div className=" flex gap-3 items-center">
                ...
                <div className="inline-flex">
                    <button
                        ...
                        className={`flex items-center justify-center size-10 text-sm font-medium border-y first:border-l last:border-r border-gray-200 first:rounded-l-lg last:rounded-r-lg dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white disabled:opacity-50 disabled:pointer-events-none`}>
                        <LuChevronLeft />
                    </button>
                    <button
                        disabled={!first}
